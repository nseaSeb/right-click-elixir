defmodule PetalBoilerplateWeb.PageLive do
  ...
  def render(assigns) do
    ...
    <.container class="mt-10 mb-32">
      <.h2 underline class="mt-10" label="Right click sample" />
      <div  >
      <.h3 id="id_1" label="right click me (id_1)" phx-hook="rightClickHook"/>
      <.h3 id="id_2" label="right click me (id_2)" phx-hook="rightClickHook"/>
      </div>
  ...
  @impl true
  def handle_event("right-click", async_fun_result, socket) do
    IO.inspect(async_fun_result)
    {:noreply, socket}
  end
