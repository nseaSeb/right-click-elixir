...
`);
    ...
    mounted() {
      this.el.addEventListener("contextmenu", (event) => {
        ...
        let payload = {
          ...
          additional_data: "any_other_data"
        };
        this.pushEvent("right-click", payload);
      });
    },
    beforeUpdate() {
    },
  ...
  var right_hook_default = rightClickHook;

  // js/hooks/index.js
  var hooks_default2 = {
    ColorSchemeHook: color_scheme_hook_default,
    rightClickHook: right_hook_default
  };
